...
return [
    ...
    */
    ...
    'voice_over_studio_multiplier' => env('VOICE_OVER_STUDIO_MULTIPLIER', 1),

    'video_dub_studio_multiplier' => env('VIDEO_DUB_STUDIO_MULTIPLIER', 5),

    'audio_dub_studio_multiplier' => env('AUDIO_DUB_STUDIO_MULTIPLIER', 3),

    'characters_multiplier_per_second' => 16,
