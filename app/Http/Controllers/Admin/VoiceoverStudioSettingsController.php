...
class VoiceoverStudioSettingsController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.studio.settings.voiceover.index', compact('languages', 'voices'));
    }
    ...
    public function store()
    {
        ...
        if (request('voice')) {
            ...
            if ($voice->language_code != request('language')) {
                return redirect()->back()->with('error', __('Selected voice does not belong to this language, select correct one'));
            }
        }
        ...
        $this->storeConfiguration('VOICE_OVER_STUDIO_MULTIPLIER', request('set-voice-over-studio-multiplier'));
        $this->storeConfiguration('VIDEO_DUB_STUDIO_MULTIPLIER', request('set-video-dub-studio-multiplier'));
        $this->storeConfiguration('AUDIO_DUB_STUDIO_MULTIPLIER', request('set-audio-dub-studio-multiplier'));
