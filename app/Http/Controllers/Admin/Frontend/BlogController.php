...
class BlogController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.settings.blog')->with('success', __('Blog successfully created'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $blog->author_url = request('author_url');
        $blog->date = request('date');
        $blog->keywords = request('keywords');
        $blog->body = request('content');
        $blog->save();

        return redirect()->route('admin.settings.blog')->with('success', __('Blog successfully updated'));
    }
