...
class FAQController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.settings.faq')->with('success', __('FAQ answer successfully created'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.settings.faq')->with('success', __('FAQ answer successfully updated'));
    }
