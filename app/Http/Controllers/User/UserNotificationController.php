...
class UserNotificationController extends Controller
{
    ...
    public function markAllRead()
    {
        ...
        return redirect()->route('user.notifications')->with('success', __('All notifications are marked as read'));
    }
    ...
    public function deleteAll()
    {
        ...
        return redirect()->route('user.notifications')->with('success', __('All notifications are deleted'));
    }
