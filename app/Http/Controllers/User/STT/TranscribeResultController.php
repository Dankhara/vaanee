    ...
    {   
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->rawColumns(['actions', 'created-on', 'custom-status', 'custom-length', 'custom-language', 'custom-mode', 'result', 'download', 'single', 'type'])
                    ->make(true);
    ...
    {   
        if ($request->ajax()) {
            ...
            if ($request->json && !$request->speaker) {
                ...
                $data = TranscribeResult::where('id', $request->id)->pluck('text');
            }
