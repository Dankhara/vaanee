                ...
                <footer class="footer section pb-0">
                    <div class="container">
                        <div class="row items-gap-two">
                            ...
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="footer__single wow fadeInUp" data-wow-duration="600ms" data-wow-delay="800ms">
                    ...
                    <div class="anime">
                        <img src="{{ asset('assets/images/footer-anime-one.png') }}" alt="Image" class="one">
                        <img src="{{ asset('assets/images/footer-anime-two.png') }}" alt="Image" class="two">
                    </div>
                </footer>
                <!-- ==== / footer end ==== -->
            </div>
