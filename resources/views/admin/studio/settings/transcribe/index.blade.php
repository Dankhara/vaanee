				...
				<div class="card-body">
					...
					<form action="{{ route('admin.transcribe.settings.store') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="row">							
							...
							<div class="col-lg-6 col-md-6 col-sm-12">	
								<div class="input-box">								
									<h6>{{ __('Max Audio Length for Live Transcribe') }} <span class="text-muted">({{ __('in Minutes') }}) ({{ __('for Users') }}) <i class="ml-2 fa fa-info info-notification" data-tippy-content="{{ __('Only for AWS. Can be set up to 240 Minutes') }}."></i></span></h6>
									<div class="form-group">							    
