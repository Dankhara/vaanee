			...
			<div class="card border-0">
				<div class="card-header">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li><a data-toggle="tab" href="#tab1">
                                <h3 class="card-title">{{ __('Modal 1') }}</h3>
                            </a></li>
                        <li><a data-toggle="tab" href="#tab2">
                            <h3 class="card-title">{{ __('Modal 2') }}</h3>
                        </a></li>
                    </ul>
				</div>
				<div class="card-body pt-2 tab-content">
                    ...
                    <div class="box-content tab-pane fade"  id="tab1">
                        <!-- SET DATATABLE -->
                        <table id='modal1' class='table' width='100%'>
                                <thead>
                                    <tr>
                                        <th width="5%">{{ __('Status') }}</th>
                                        <th width="2%">{{ __('Vendor') }}</th>
                    ...
                    <div class="box-content tab-pane fade" id="tab2">
                        <!-- SET DATATABLE -->
                        <table id='modal2' class='table' width='100%'>
                                <thead>
                                    <tr>
                                        <th width="5%">{{ __('Status') }}</th>
                                        <th width="2%">{{ __('Vendor') }}</th>
