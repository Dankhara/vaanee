				...
				<div class="card-body">
					...
					<form action="{{ route('admin.settings.frontend.store') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">
								<h6 class="fs-12 font-weight-bold mb-4">{{ __('Cases Section') }}</h6>
								<div class="form-group mb-4">
									<label class="custom-switch">
										<input type="checkbox" name="cases" class="custom-switch-input" @if ( config('frontend.cases_section')  == 'on') checked @endif>
										<span class="custom-switch-indicator"></span>
										<span class="custom-switch-description">{{ __('Show') }}</span>
									</label>
								</div>
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											<h6><i class="fa-brands fa-twitter mr-2"></i>Twitter <span class="text-muted"></span></h6>
											<div class="form-group">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											<h6><i class="fa-brands fa-facebook-f mr-2"></i>Facebook <span class="text-muted"></span></h6>
											<div class="form-group">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											<h6><i class="fa-brands fa-linkedin-in mr-2"></i>LinkedIn <span class="text-muted"></span></h6>
											<div class="form-group">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											<h6><i class="fa-brands fa-instagram mr-2"></i>Instagram <span class="text-muted"></span></h6>
											<div class="form-group">
