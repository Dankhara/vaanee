...
@section('content')						
	...
	<div class="row">
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<p class=" mb-3 fs-12">{{ __('Voiceover Studio Tasks') }} <span class="text-muted">({{ __('Current Month') }})</span></p>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<p class=" mb-3 fs-12">{{ __('Free Minutes Used') }} <span class="text-muted">({{ __('Current Month') }})</span></p>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<p class=" mb-3 fs-12">{{ __('Paid Minutes Used') }} <span class="text-muted">({{ __('Current Month') }})</span></p>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<p class=" mb-3 fs-12">{{ __('Purchased Minutes') }} <span class="text-muted">({{ __('Current Month') }})</span></p>
					<h2 class="mb-2 number-font fs-20">{{ number_format($total_data_monthly['purchased_minutes'][0]['data']) }}</h2>
					<small class="fs-12 text-muted">{{ __('Compared to Last Month') }} (<span id="purchased_minutes_past"></span>): </small>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<p class=" mb-3 fs-12">{{ __('Transcribe Studio Tasks') }} <span class="text-muted">({{ __('Current Month') }})</span></p>
					<h2 class="mb-2 number-font fs-20">{{ number_format($total_data_monthly['transcribe_tasks'][0]['data']) }}</h2>
					<small class="fs-12 text-muted">{{ __('Compared to Last Month') }} (<span id="tasks_past"></span>): </small>
