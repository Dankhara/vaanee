...
@section('page-header')
    ...
    <div class="page-header mt-5-7">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">{{ __('My Voice Profile') }}</h4>
            <ol class="breadcrumb mb-2">
                <li class="breadcrumb-item"><a href="{{ route('user.dashboard') }}"><i
                            class="fa-sharp fa-solid fa-waveform-lines mr-2 fs-12"></i>{{ __('User') }}</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('user.record.user.voice') }}">
                        {{ __('Record Voice') }}</a></li>
            </ol>
        </div>
    </div>
    <!-- END PAGE HEADER -->
