...
@section('page-header')
    ...
    <div class="page-header mt-5-7">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">{{ __('Text Dub Studio') }}</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 pr-0 pr-minify">
                                                <div class="input-box">
                                                    ...
                                                    <input type="hidden" name="project_type" value="audio" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div id="upload-container">
                                                ...
                                                <div class="select-file">
                                                    <input type="file" name="filepond" id="filepond"
                                                        class="filepond" accept=".txt" required />
                                                </div>
                                                @error('filepond')
