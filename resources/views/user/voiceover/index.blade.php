...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		<h4 class="page-title mb-0">{{ __('Voiceover Studio') }}</h4>
		<ol class="breadcrumb mb-2">
			...
			<li class="breadcrumb-item active" aria-current="page"><a href="{{ route('user.voiceover') }}"> {{ __('Voiceover Studio') }}</a></li>
		</ol>
	</div>
</div>
<!-- END PAGE HEADER -->
							...
							<div class="row" id="tts-awselect">
								...
								<div class="col-md-3 col-sm-12">
									<div class="input-box mb-0" id="textarea-box">
										<input type="text" class="form-control" name="title" id="title" placeholder="{{ __('Text Title (Optional)') }}">
									</div>
								</div>
							</div>
							...
							@if (config('tts.ssml_effect') == 'enable')
								<div class="row mb-6">
									...
									<div class="col-md col-sm-12 special-buttons" id="upload-file">
										<div class="dropdown">
											<button class="btn btn-special" type="button" onclick="readFile();" id="read-file">{{ __('Upload File') }}</button>
										</div>
									</div>
								</div>
							@endif
											...
											<div id="textarea-row-box">
												<div class="textarea-row" id="maintextarea">
													...
													<div class="textarea-text">
														<textarea class="form-control textarea" name="textarea[]" id="ZZZOOOVVVZ" data-voice="" onkeyup="countCharacters();" onmousedown="mouseDown(this);" rows="1" placeholder="{{ __('Enter your text here to synthesize') }}..." maxlength="3000"></textarea>
													</div>
                                ...
                                <div class="row">
									...
									<div class="col-sm-12">
										<div id="controls" class="mt-4 mb-3">
											...
											@if ( config('tts.listen_download')  == 'enable') <a id="downloadBtn" class="result-play result-play-sm" href="" download><i class="fa fa-download"></i></a> @endif
										</div>
									</div>
								</div>
							</div>
...
@section('js')
	...
	<script type="text/javascript">
		$(function () {
			...
			let user_voice = "{{ auth()->user()->voice }}";
