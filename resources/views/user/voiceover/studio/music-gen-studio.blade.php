...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		<h4 class="page-title mb-0">{{ __('Music Gen Studio') }}</h4>
		<ol class="breadcrumb mb-2">
			<li class="breadcrumb-item"><a href="{{ route('user.dashboard') }}"><i class="fa-solid fa-photo-film-music mr-2 fs-12"></i>{{ __('User') }}</a></li>
			<li class="breadcrumb-item active" aria-current="page"><a href="{{ route('user.sound.studio') }}"> {{ __('Music Gen Studio') }}</a></li>
		</ol>
	</div>
</div>
<!-- END PAGE HEADER -->
		...
		<div class="col-lg-12 col-md-12 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title"><i class="fa-solid fa-photo-film-music mr-2 text-primary"></i> {{ __('Music Gen Studio') }}</h3>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-12 pr-5 pr-minify">
							<div class="row">
								<div class="col-md-12 col-sm-12">
									<div class="input-box">
										<h6 class="task-heading">{{ __('Cover Voice') }}</h6>
										<select id="cover-voice" name="cover-voice" data-placeholder="{{ __('Set Final Result Volume') }}:">
						...
						<div class="col-md-3 col-sm-12 pl-5 pl-minify">
							<div class="row">
								...
								<div class="col-md-12 col-sm-12 text-center" id="audio-format-minify">
									<div class="input-box">
