...
@section('page-header')
    ...
    <div class="page-header mt-5-7">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">{{ __('Audio Dub Studio') }}</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 pr-0 pr-minify">
                                                <div class="input-box">
                                                    ...
                                                    <input type="hidden" name="project_type" value="text" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 pr-0 pr-minify">
                                                <div class="input-box">
                                                    ...
                                                    <select id="project-audio-model" name="model"
                                            ...
                                            <div id="upload-container">
                                                ...
                                                <div class="select-file">
                                                    <input type="file" name="filepond" id="filepond"
                                                        class="filepond" accept="audio/*" required />
                                                </div>
                                                @error('filepond')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#vidoe-meta-data').click(function(e) {
                ...
                formData.append('project_type', 'text');
                ...
                getDuration().then((duration) => {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            Swal.fire('Audio uploaded successfully.');
            ...
            function loadSourceTranscription(){
                $.ajax({
                    ...
                    type: "GET",
                    data: {project_id: localStorage.getItem('project_id'), project_type: 'audio'},
                    contentType: false,
                    beforeSend: function() {
                        $("#preloader").show();
                    },
                    ...
                    success: function(data) {
                        if(data.message && data.response.success){
                            if(data.response.result != null){
                                ...
                                var template = $("#target-transcription-template")
            ...
            function confirmSourceTranscription(changeRequired){
                ...
                formData.append('project_type', 'audio');
